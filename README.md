...
## Environments
- Preview: https://main--haverty-test--s-babineau.aem.page/
- Live: https://main--haverty-test--s-babineau.aem.live/
...
1. Open the `haverty-test` directory in your favourite IDE and start coding :)
